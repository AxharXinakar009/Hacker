#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To axharo_hacker
...
CorrectUsername = "axharo"
CorrectPassword = "xinakar"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:axharo_hacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://m.Facebook.com/AxHarOo')
    else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:AXHARO_HACKER
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mKali.Linux\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;93m«---•◈•---Developed By love-Hacker--•◈•---»" #Dev:axharo_hacker
	print '\033[1;91m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 xinakar.py)↩\033[1;92m....'
...
•\033[1;91m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;93m .....XINAKAR  Kali.linux....... \033[1;91m :
•\033[1;91m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;93m +923154321117"""
